...
//   // Ініціалізація галереї в глобальній змінній, якщо вона ще не створена
//   if (!gallery) {
...
//   gallery.refresh(); // Оновлюємо галерею після додавання нових елементів
// }
